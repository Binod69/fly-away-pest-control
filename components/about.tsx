  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-sm md:text-lg text-textColor opacity-70 max-w-3xl mx-auto mb-8">
        ...
        <div className="mt-8 mb-16">
          {/* <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            We understand that every home is unique, which is why we develop
            customized solutions for each customer. Using eco-friendly products
            and proven techniques, we eliminate current pest problems and
            prevent future infestations, all while keeping your family and pets
            safe.
          </p> */}
        </div>
          ...
          {features.map((feature, index) => (
            <Card key={index} className="p-6">
              <div className="flex flex-col items-center text-center">
                <feature.icon className="h-12 w-12 text-[#C10055] mb-4" />
